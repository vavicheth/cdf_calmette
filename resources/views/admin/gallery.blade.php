...
@section('header_styles')
    ...
    <style>
        #fancybox-thumbs ul li a{
            ...
            background-image: url('{{ asset('assets/img/img_holder/gal/4.jpg') }}');
        }
                        ...
                        <div class="table-lg">
                            <div class="nav-tabs-custom">
                                ...
                                <div class="tab-content" id="clothing-nav-content">
                                    ...
                                    <div class="tab-pane fade show active gallery-padding" id="tab_1">
                                        <div class="row">
                                            <div class="col-lg-2 col-md-3 col-6 col-sm-3 gallery-border">
                                    ...
                                    <!-- /basic gallery -->
                                    <div class="tab-pane  fade gallery-padding" id="tab_2">
                                        <div class="row">
                                        <div class="col-md-12 col-lg-12 col-12 ">
                                            ...
                                            <div class="row">
                                            <div class="col-lg-2 col-md-2 col-6 col-sm-3 gallery-border">
                                                <a class="fancybox"
                                                   href="{{ asset('assets/img/img_holder/gal/2.jpg') }}"
                                                   data-fancybox-group="gallery" title="Image Title 2">
                                                    <img src="{{ asset('assets/img/img_holder/gal/2.jpg') }}"
                                            ...
                                            <div class="col-lg-2 ol-md-2 col-6 col-sm-3 gallery-border">
                                                <a class="fancybox"
                                                   href="{{ asset('assets/img/img_holder/gal/2.jpg') }}"
                                                   data-fancybox-group="gallery" title="Image Title 2">
                                                    <img src="{{ asset('assets/img/img_holder/gal/2.jpg') }}"
                                    ...
                                    <!-- /standard gallery -->
                                    <div class="tab-pane fade gallery-padding" id="tab_3">
                                        <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                            <div class="col-lg-2 col-md-2 col-6 col-sm-3 gallery-border">
                                    ...
                                    <div class="tab-pane fade gallery-padding" id="tab_4">
                                        <div class="row">
                                        <div class="col-md-12 col-lg-12 col-12">
                                            <div class="row">
                                            <div class="col-lg-2 col-md-2 col-6 col-sm-3 gallery-border">
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{ asset('assets/js/pages/jquery_fancy_thumb.js') }}"></script>
