                                        ...
                                        <div class="card-body">
                                            <form action="#">
                                                ...
                                                <div class="form-actions text-right ">
                                                    ...
                                                    <button type="button" class="btn btn-danger">Cancel</button>
                                                    &nbsp;
                                                    <input type="reset" class="btn btn-default d-none d-sm-block" value="Reset">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card panel-info">
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label for="inputEmail" class="control-label col-2 hidden-xs">Email</label>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label for="staticPassword" class="control-label col-2 hidden-xs">Password</label>
                                    ...
                                    <div class="card panel-success">
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label for="inputEmail_1" class="control-label col-2">Email</label>
                                                        <div class="col-10">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <label for="inputPassword" class="control-label d-none d-sm-block col-2">Password</label>
                                    ...
                                    <div class="card panel-danger my-3">
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal">
                                                <div class="form-group has-success">
                                                    <div class="row">
                                                        <label class="col-12 control-label" for="inputSuccess">Username</label>
                                                        <div class="col-12">
                                                ...
                                                <div class="form-group has-warning">
                                                    <div class="row">
                                                        <label class="col-12 control-label" for="inputWarning">Password</label>
                                                        <div class="col-12">
                                                ...
                                                <div class="form-group has-error">
                                                    <div class="row">
                                                        <label class="col-12 control-label" for="inputError">Email</label>
                                                        <div class="col-12">
                                            ...
                                            <form class="form-horizontal">
                                                <div class="form-group has-success has-feedback">
                                                    <div class="row">
                                                        <label class="col-12 control-label" for="inputSuccess3">Username</label>
                                                        <div class="col-12">
                                                ...
                                                <div class="form-group has-warning has-feedback">
                                                    <div class="row">
                                                        <label class="col-12 control-label" for="inputWarning2">Password</label>
                                                        <div class="col-12">
                                                ...
                                                <div class="form-group has-error has-feedback">
                                                    <div class="row">
                                                        <label class="col-12 control-label" for="inputError2">Email</label>
                                                        <div class="col-12">
