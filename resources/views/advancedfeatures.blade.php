    ...
    <div class="container advfeatures">
        ...
        <div class="row advanced">
            ...
            <div class="col-md-6 col-lg-6 col-sm-6 col-12">
                <h3>Buttons</h3>
                <button type="button" class="btn btn-responsive button-alignment btn-dark" data-toggle="button">Submit</button>
                <button type="button" class="btn btn-responsive button-alignment btn-light" data-toggle="button">Submit</button>
