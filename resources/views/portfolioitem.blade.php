            ...
            <div class="col-md-12  col-lg-6 col-12 wow bounceInLeft" data-wow-duration="1.5s">
                ...
                <div class="col-md-12 col-sm-12 col-lg-12 slider">
                    <div id="owl-demo" class="owl-carousel owl-theme">
                        <div class="item"><img src="{{ asset('assets/images/16.jpg') }}" alt="slider-image" class="img-fluid">
                        </div>
                        <div class="item"><img src="{{ asset('assets/images/14.jpg') }}" alt="slider-image" class="img-fluid">
                        </div>
                        <div class="item"><img src="{{ asset('assets/images/15.jpg') }}" alt="slider-image" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <!--<div class="col-md-12 col-lg-12 col-12 project_images">-->
                <div class="col-md-6 col-lg-3 col-12   project_images">
                    <a href="#"><img src="{{ asset('assets/images/gallery/3.jpg') }}" class="img-fluid"></a>
                </div>
                <div class="col-md-6 col-lg-3 col-12  project_images">
                    <a href="#"><img src="{{ asset('assets/images/gallery/5.jpg') }}" class="img-fluid"></a>
                </div>
                <div class="col-md-6 col-lg-3 col-12  project_images">
                    <a href="#"><img src="{{ asset('assets/images/gallery/7.jpg') }}" class="img-fluid"></a>
                </div>
                <div class="col-md-6 col-lg-3 col-12  project_images">
                    <a href="#"><img src="{{ asset('assets/images/gallery/10.jpg') }}" class="img-fluid"></a>
                </div>
            </div>
        </div>
        <!-- Related Setion End -->
